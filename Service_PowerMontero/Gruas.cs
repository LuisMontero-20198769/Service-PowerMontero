    ...
    class Gruas : ICampana
    {
        ...
        public void Servicios()
        {
            ...
            if (opcionImp == 1)
            {
                ...
                Impresora.GetImprimir();//Metodo que imprimira los datos del vehiculo
        ...
        //Metodo que guarda los detalles del vehiculo
        public void Comprobante()
        {
            var fecha = DateTime.Now;//Fecha del sistema...
            Console.WriteLine("Equipo rentado: Gruas");
